...
$cfg_multi_site = 'N';
$cfg_dede_log = 'N';
$cfg_powerby = 'Copyright © 2018 无锡狮子王科技有限公司 版权所有';
$cfg_arcsptitle = 'N';
$cfg_arcautosp = 'N';
...
$cfg_rewrite = 'N';
$cfg_delete = 'Y';
$cfg_keywords = '无锡狮子王科技';
$cfg_description = '狮子王自主品牌的信息安全产品及整体解决方案供应商，布局信息安全、互联网、大数据为公司三大战略方向，为用户提供业界领先的产品与服务。
在信息安全领域，现已构筑了三纵四横的新一代终端安全管理体系，从内网安全、数据安全、边界安全三个方向对Windows终端、国产终端、移动终端、虚拟化终端提供全方位、立体化的安全保护。产品覆盖政府、军队军工、公安、金融、能源等重要行业数千家单位，成功部署数千万终端，连续十一年稳居中国终端安全管理领域的市场领导者地位。         
';
...
$cfg_dh = '0510-85911100';
$cfg_cz = '0510-85911100';
$cfg_qq = '';
$cfg_yx = 'zj@jslcwy.com';
$cfg_dz = '无锡滨湖区楝泽路29号软件园三期17栋三楼';
$cfg_weibo = '';
$cfg_top = '狮子王秉承“信息之源、信誉之源、信心之源”的核心理念，依靠领先的产品、技术与服务，本着一如既往继往开来的创新姿态，为构筑安全的中国互联网生态系统而不懈努力。';
$cfg_sj = 'Mon-Fri 9：00-18：00';
?>